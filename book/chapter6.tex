...
\begin{figure}[h!]
\center
	\includegraphics[width=450px]{service/4.png}
...
\begin{figure}[h!]
\center
	\includegraphics[width=450px]{service/6.png}
	\caption{Выбор сервера}
	\label{pict:projectserver}
\end{figure}
...
\begin{figure}[h!]
\center
	\includegraphics[width=450px]{service/7.png}
	\caption{Выбор сервера}
	\label{pict:projectserver}
\end{figure}
\begin{figure}[h!]
\center
	\includegraphics[width=450px]{service/8.png}
	\caption{Выбор сервера}
	\label{pict:projectserver}
\end{figure}
\begin{figure}[h!]
\center
	\includegraphics[width=450px]{service/9.png}
	\caption{Выбор сервера}
	\label{pict:projectserver}
\end{figure}
\begin{figure}[h!]
\center
	\includegraphics[width=450px]{service/10.png}
	\caption{Выбор сервера}
	\label{pict:projectserver}
\end{figure}
\begin{figure}[h!]
\center
	\includegraphics[width=450px]{service/11.png}
	\caption{Выбор сервера}
	\label{pict:projectserver}
\end{figure}
\begin{figure}[h!]
\center
	\includegraphics[width=450px]{service/12.png}
	\caption{Выбор сервера}
	\label{pict:projectserver}
\end{figure}
